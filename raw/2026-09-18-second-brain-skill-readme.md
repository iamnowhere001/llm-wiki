---
title: "Second Brain Skill — README"
author: ChavesLiu
url: https://github.com/ChavesLiu/second-brain-skill
repo: ChavesLiu/second-brain-skill
kind: repo-readme
repo_created: 2026-04-14
repo_last_push: 2026-04-15
stars_at_capture: 54
forks_at_capture: 9
language: Python
license_claim: README 声明 MIT
license_detected: GitHub API 的 license 字段为空（不一致，待核）
readme_sha: b5e131c6adfeb1ea5590dcf67871c328d4926937
clipped: 2026-09-18
capture_note: >
  逐字副本，取自 GitHub API 的 readme 端点并 base64 解码，不是网页抓取，
  因此不存在行内链接丢失的问题。上游仓库 ChavesLiu/second-brain-skill。
---

> 采集说明：本文件是 `ChavesLiu/second-brain-skill` 仓库 README.md 的逐字副本。
> 该仓库自称「参考 Karpathy Wiki 的思路」，因此与 [[2026-09-18-karpathy-llm-wiki]] 相关，
> 但它**不是** Karpathy 的 Gist 的一部分。
