...
kind: course-article
series: 得到《现代思维工具课》「模块七 演化者」正文｜讲次表编号（推定）103
...
capture_method: >
  ...
  document_id: RLBXdaiwzozkdVxqz36c4feJnGe ｜ revision_id: 96 ｜ 正文 7,079 字符 / 179 行（均指本文件去掉 frontmatter 之后的正文）。
  结构化端点抓取：标题层级、行内链接、加粗标记、引用块均保留；未做 HTML 渲染，无 `→` 转 `->` 一类损失。
  内嵌图片 0/8 张已下载，→ raw/assets/2026-09-19-marginal-analysis-img-NN.*，序号按正文出现顺序。
...
![图片是一幅漫画，描述了一家餐馆因顾客增多而陷入混乱的场景。画面中，餐馆内顾客众多，服务员忙得不可开交，有的端着盘子，有的在清理桌子。画面中出现“再加一桌，能接！”“全堵住了！”“两桌催菜，一桌退桌！”等对话，反映出顾客数量增加导致的服务压力。最后，服务员无奈地说“少赚一桌，也得撤”，表明新增顾客导致边际效益为负，需减少顾客数量。此图与上下文关于边际分析的内容相呼应，直观呈现了边际效益为负时的场景。](https://feishu.cn/file/XV4YbfkQYo0uaRxAagCc3G19nJg)
...
![图片展示了边际效益与趋势（trend）的四种组合情况。当边际效益为正（>0）且趋势递增（rising）时，应全力加仓，处于最好的日子，是正反馈飞轮；当边际效益为正且趋势递减（falling）时，应见好即变，仍赚但前途有限，预备第二曲线；当边际效益为负（<0）且趋势递增时，应耐心播种，眼下亏损但趋势向好，早晚回正；当边际效益为负且趋势递减时，应立即止损，赔钱的无底洞，别犹豫退出。该图与上下文结合，帮助判断边际效益为负且趋势改善时是否值得继续投入。](https://feishu.cn/file/D6hwbya9moQCdpxpI5ccmH7gnfd)
...
![图片展示了S曲线生命周期的三个阶段。冷启动期投入大、动静小，斜率低；飞轮期边际效益递增，一飞冲天，斜率高；饱和期边际效益递减，曲线渐平，斜率低。图中还标注了关键点，如增长由加速转为减速的拐点，以及“到来之前，平静第二曲线”的提示。该图与上下文紧密相关，直观呈现了产品生命周期中总成果随累计投入变化的趋势，帮助理解产品在不同阶段的特点。](https://feishu.cn/file/SVCkbtKCJoW6Y0xcmlucPzxmn1g)
...
![图片展示了“第二曲线：长期增长是一场接力”的内容，说明每一条局部S曲线都会变平，下一条必须在旧曲线到顶之前启动。图中以曲线1、2、3、4、5表示不同增长阶段，其中曲线1为旧曲线，曲线2、3、4为新曲线，曲线5为长期增长方向。曲线1在旧曲线到顶之前启动了曲线2，曲线2在曲线1到顶之前启动了曲线3，以此类推。该图与上下文紧密相关，直观呈现了长期增长需不断开辟新曲线的接力过程。](https://feishu.cn/file/Dj8EbiddZoTbGUxMwH0csee6nwc)



请注意这个时机 —— 第二曲线的启动必须是在旧曲线到顶之前。这是因为开辟新曲线需要钱、需要人、需要士气，这三样东西只有在旧曲线还在上升的时候你才有。等到旧曲线的新增回报连新探索都供养不起，人、钱和士气开始收缩，再换棒可就晚了。

![这张图片是一幅讲述开辟第二曲线的插画，以类似戏曲连环画的形式呈现。画面中，老年女性在旧业务（戏曲演出）仍火爆时，主动选择停止旧曲，撤掉相关票务准备，在旧曲线价值尚在的时机开启新的戏曲表演项目。图片中的情节恰好对应文档中“在旧曲线到顶之前开辟第二曲线”的核心观点，即主动让新产品/新业务侵蚀自身原有热门业务，为后续持久增长奠定基础。](https://feishu.cn/file/CGT1bzFliodu0txreBacURu2nvd)
...
![图片展示了边际效益的四种局面及一条活路。横轴为边际效益，分为正负；纵轴为趋势，分改善与恶化。图中用箭头和文字标注了冷启动、黄金期、成熟期、无底洞四个阶段，其中黄金期和成熟期对应边际效益为正，冷启动和无底洞对应边际效益为负。还标注了第二曲线、主动跳回冷启动格等关键信息。底部文字强调健康事业应从右下格跳回左上格。此图与上下文关于边际效益递减及敏感判断的内容相呼应。](https://feishu.cn/file/Q4b8byf3Voak5Fxhh96cQWfvnxd)
...
![图片展示了乾卦里藏着的两条曲线，即“亢龙有悔”和“自强不息”。其中，“亢龙有悔”管一条曲线之内，“自强不息”管曲线与曲线之间。图中蓝色曲线代表“亢龙有悔”，从“潜龙勿用”到“见龙在田”，再到“飞龙在天”，最后“亢龙有悔”；橙色曲线代表“自强不息”，在“亢龙”之前另起一段乾卦。该图与上下文紧密相关，直观呈现了两条曲线在乾卦中的作用层次。](https://feishu.cn/file/JytHb8yntonD2txPeWUckMvdnOe)
...
![图片为“边际分析：怎样判断值不值得继续投入？”的内容总结图。图中以“用一个单位的投入，能带来多少新增的产出？”决定下一次的投入为引言，涵盖核心思想、边际收益、边际成本、四种局面、第二曲线、应用到中国经济、小满到底值不值等板块，还展示了5曲线、多一条5曲线接力等内容。图中还配有“有诗为证”“生活中的边际分析”“一言总结”等板块，整体是对边际分析相关知识的系统呈现。](https://feishu.cn/file/LsjzbjlmpoJSipxnPtZc30oVnmb)