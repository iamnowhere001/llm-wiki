...
kind: mixed-notes
series: 得到《现代思维工具课》「模块二 决策判断」问答｜无发刊词编号（发刊词目录问答不占号）｜【2026-09-21 裁定】原值：「得到《现代思维工具课》「模块二 决策判断」讲次表编号 041（模块内第 16 项，问答）｜【2026-09-19 更正】原值：「得到《现代思维工具课》「模块二 决策判断」问答（无官方编号）」」
published: 未标注
clipped: 2026-09-19
