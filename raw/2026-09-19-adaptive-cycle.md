...
capture_method: >
  ...
  document_id: KhjQdaxtro8FkUx8SxDcUa4tnle ｜ revision_id: 82 ｜ 正文 6,646 字符 / 176 行（均指本文件去掉 frontmatter 之后的正文）。
  结构化端点抓取：标题层级、行内链接、加粗标记、引用块均保留；未做 HTML 渲染，无 `→` 转 `->` 一类损失。
  内嵌图片 0/6 张已下载，→ raw/assets/2026-09-19-adaptive-cycle-img-NN.*，序号按正文出现顺序。
...
![图片展示了适应性循环的图示，以∞形状呈现，分为前环和后环。前环r（开拓）代表新东西冒出来抢占空间，后环Ω（释放）是旧结构崩解、资源被释放。前环r→K（守成）是资本积累、规则成型，后环Ω→α（空·重组）是旧格局散尽、一切重新洗牌。该图与上下文紧密相关，直观呈现了成、住、坏、空的循环过程，与生态学中的“r”“K”“Ω”“α”对应，帮助理解文中提到的适应性循环概念。](https://feishu.cn/file/BphVb0x0sofygxxfemacfQ5knvb)
...
![图片展示了现代供应链在守成期的运作场景。画面中，工人在工厂内忙碌，有检查库存、操作机器、组装产品等场景。上方文字“今天，刷新纪录”“最后一点缓冲啦？”“三年没断过，再减”“上游停产半天”等，体现了供应链对效率的追求。画面下方有蓝色塑料箱和整齐排列的白色设备，展示了生产环境。该图与上下文紧密相关，通过漫画形式直观呈现了现代供应链在守成期的运作状态，与上下文提到的“准时制”理念及新冠疫情对供应链的影响相呼应。](https://feishu.cn/file/B7NwbNSP0ocJpkxyXnkcHnDZnxh)
...
![图片展示了林火扑救及森林恢复的场景。画面中有身着制服、头戴安全帽的人员，他们手持工具，正在灭火。背景是被烧毁的森林，有被烧焦的树木和流淌的水流。画面中还出现了一位年长者，他手持工具，神情严肃。此外，还有画面显示森林中水流湍急，以及一只鸟在空中飞翔。图片通过这些场景，形象地呈现了林火扑救及森林恢复的过程，与上下文关于循环嵌套和不同尺度循环互动的论述相呼应。](https://feishu.cn/file/V29xbJou4or4dUxc2BYcN19VnWh)
...
![这张图展示了“多尺度嵌套（Panarchy）”模型，呈现了多层嵌套的循环结构，自上而下依次为“小·快”“中”“大·慢”三个不同尺度的循环，从“小·快”到“大·慢”分别对应一季的叶片/个人、数年的树/公司、百年的森林/文明，转得越快规模越小，转得越慢规模越大。图中左侧橙色箭头标注“反叛 revolt”，标注说明小尺度崩溃会向上级联，如一粒火星引发大火改变整片山林；右侧绿色箭头标注“记忆 remember”，说明大尺度会留存生存材料，例如种源、土壤等文化与资源，对应了不同尺度循环间的互动关系。](https://feishu.cn/file/Hyc3bTuYeouxDQxuX20cIqo9nvd)
...
![这是一张阐述“稳定≠韧性”概念的示意图，以“球在盆中”的模型清晰呈现核心内容。图中用一个蓝色小球代表当前处于“清水态”的系统，实线虚线分别对应不同状态，清晰标注了相关关系，包括“回弹快=稳定”，“盆变浅→韧性↓、慢变量抬高盆底”等逻辑点，还有“临界·翻盘点”标注着“一次大冲击→换一个系统”的关系，明确稳定和韧性的核心差异，即稳定是看盆壁陡峭度（球弹回原位的速度），韧性是看盆底宽度与深度（系统承受大冲击后是否切换、是否能复原），该图和上下文的湖泊生态、资本市场的稳定与韧性内容相呼应，直观解释了稳定与韧性的区别。](https://feishu.cn/file/VQMXbuV4hoTJHAxzQglc6HQEn0M)
...
![图片是关于“成住坏空，生生不息——用适应性循环理解衰兴的智慧”的思维工具图。图中以“成”“住”“坏”“空”四个阶段呈现适应性循环，包含“开拓”“守成”“释放”“成住坏空的智慧”四个环节，还展示了“多尺度看”“有偈为证”等内容。该图与上下文紧密相关，是对适应性循环这一概念的直观呈现，帮助理解衰兴的智慧。](https://feishu.cn/file/ZfXlb44qwoWVbTxQryvcL27KnHd)