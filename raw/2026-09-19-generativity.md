...
capture_method: >
  ...
  document_id: D0s6dQebno21IlxreEzcdSrsnog ｜ revision_id: 91 ｜ 正文 7,533 字符 / 192 行（均指本文件去掉 frontmatter 之后的正文）。
  结构化端点抓取：标题层级、行内链接、加粗标记、引用块均保留；未做 HTML 渲染，无 `→` 转 `->` 一类损失。
  内嵌图片 0/5 张已下载，→ raw/assets/2026-09-19-generativity-img-NN.*，序号按正文出现顺序。
...
![图片为漫画风格，展示了一位白发老者与一位黑发男子的对话场景。老者手持长剑，神情严肃，对男子说“你一死，这世界也会死”，男子则回应“那我就斩断”。画面中还出现“开天者”“不知道”等对话，以及“生成”“万维钢字幕组”等文字。该图片与上下文讨论创造自己小世界的内容相呼应，通过漫画形式呈现了创造过程中的对话与场景，增强了故事性。](https://feishu.cn/file/DMA3bIu3vo5G45xmICNck5jln2e)
...
![图片展示了“控制半径”与“因果半径”的变化关系。横轴为时间，从创立到你不在了。纵轴为半径大小。红色折线代表控制半径，从创立时较大逐渐减小，到你不在时接近0。绿色折线代表因果半径，从创立时较小逐渐增大，到你不在时仍在增长。图中“生成”处两线相交，下方文字“你放弃的控制，成了它自己的生命”点明了生成的含义。此图与上下文关于生成不易及因果半径增大的内容相呼应。](https://feishu.cn/file/JmwLb5qvGokAJbxkoMIcXixonhf)
...
![图片为漫画风格，展示了一位年长女性与年轻女性的对话及互动场景。年长女性坐在桌旁，桌上摆放着相框、书籍等物品，年轻女性则在她对面。两人围绕着一张地图，年长女性说“这已经不是我办的学校了”，年轻女性回应“方法变了，承诺没变”。年长女性在一本打开的书上写下“给边界，不给剧本”，并递出一把钥匙。最后，年长女性对年轻女性说“奶奶，进来看着吗”，年轻女性回应“不了，挺好的”。此图与上下文关于“可演化性”及系统变化的内容相呼应。](https://feishu.cn/file/NP99bpEJnoKggyx0YPnc5ZR9nJg)
...
![这张是关于“组织闭合”与“可演化性”维度的矩阵分析图，四个象限分别对应不同的组织状态与案例。横轴代表组织闭合程度，从左到右由低变高；纵轴代表可演化性，从下到上由低变高。右上角为“生成”状态，核心是既活得下去又变得动，对应案例包括范氏义庄、哈佛、任天堂、奥运会、美国宪法；左上角为“昙花”状态，特点是常有新招但无人接棒，对应多数明星创业公司；左下角为“人亡政息”状态，特点是一退就散、资源靠输血，对应张謇的大生纱厂；右下角为“化石”状态，特点是能运转但不能修改，对应朱元璋的大明。](https://feishu.cn/file/VUqebx9xXohhbjxt0Hjc1sTxnAd)
...
![图片是关于“最高级的创造”的内容，以老子“我无为而民自化”为引，阐述了从普通到优秀再到伟大的生成者的变化。图中呈现了“为什么我们要关心‘复杂性’？”的思考，以及“三种快乐的层次”“生成（generativity）的本质”等内容。还列举了“第一门功法：组织闭合（organizational closure）”“第二门功法：可演化性（evolvability）”等“重要快乐生成，你需要掌握两门功夫”的方法。底部有“生者逝者的进阶阶梯”“为生成而诗”等小板块，以及“万维钢 现代志智工具”等信息。](https://feishu.cn/file/YjDybDuqAoO494x3zc1c2Sorneh)