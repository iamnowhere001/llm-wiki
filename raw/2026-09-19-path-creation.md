...
kind: course-article
series: 得到《现代思维工具课》「模块七 演化者」正文｜讲次表编号（推定）104
...
capture_method: >
  ...
  document_id: DUlHdlS3toLg5Rx81rycC2YfnDb ｜ revision_id: 117 ｜ 正文 6,558 字符 / 182 行（均指本文件去掉 frontmatter 之后的正文）。
  结构化端点抓取：标题层级、行内链接、加粗标记、引用块均保留；未做 HTML 渲染，无 `→` 转 `->` 一类损失。
  内嵌图片 0/6 张已下载，→ raw/assets/2026-09-19-path-creation-img-NN.*，序号按正文出现顺序。
...
![这张图围绕改革的核心控制点展开，核心内容为“改革唯一的控制点：新增流量的阀门”，明确新增流量是新人、新钱、新项目、新客户，而“导流”即该总阀门决定燃料的去向。图中呈现两条循环路径，旧路径因逐步断供飞轮燃料，最终会慢慢停止运转；新路径则通过全面导入新增流量，不断运转并加快发展。图的底部还点明，新旧两个飞轮构造完全相同，消耗同一种燃料，用户推动不了任何一个轮子，但能掌控着阀门。](https://feishu.cn/file/OeWCbWkuCo1y2axokaycZjXwnTg)
...
![图片展示了旧路径退役的正确次序，以时间轴为横轴，流量为纵轴。图中分为造路（共存期）、导流、退役三个阶段。旧路径流量先下降，新路径流量上升，二者在导流阶段交汇。图中还标注了实际死亡（新流量归零）和正式废除（文件落地）两个关键点，强调衡量改革力度的是两个时点的间距，而非废除令的力度。该图与上下文关于路径创造、路径退役等改革步骤的阐述相呼应。](https://feishu.cn/file/US8ob4P64oWbIIxMJRyc7KRdnQd)
...
![图片展示了中国改革开放初期的集装箱革命过程。1956年，一位领导人在码头边审阅图纸，随后与工人讨论，决定另搭一套新设施。接着，新设施在新泽西搭建，1956年整箱上船。画面中呈现了码头工人、领导审图、新设施搭建、集装箱装船等场景，直观呈现了从计划经济到改革开放路径改造的过程，与上下文提到的中国改革开放案例相呼应。](https://feishu.cn/file/W69mbQLewoevdnxgb53cuoXpnCh)
...
![这是一组名为《退役：最后一张粮票 1988：价格闯关》的插画，对应文档中1993年取消粮票的背景内容。插画展现了1988年粮票使用的场景：有母亲给孩子递粮票的家庭日常，人们排队购买商品时的抢购情景，以及粮票交易的相关画面；图中还配有“先买！明天更贵！”“旧供应照常，市场粮不要票”的文字标注。最后一个场景设定在1993年，孩子拿着粮票询问母亲“妈，这是什么票？”，直观呈现了粮票即将被淘汰的状态，呼应了文档中粮票取消后举国波澜不惊的内容。](https://feishu.cn/file/OnkgbdOVNorULDxgdxPcua7Tn3g)
...
![图片是路径创造的流程图，阐述了破解路径依赖的唯一可行方法。上方介绍路径创造的三步法：先默默选一条新路、决定新资源的去向、让路径在安静中退役。中间部分以“导流”为核心，说明决定新资源的去向，需考虑资源的去向、资源的去向与路径的关系、资源的去向与路径的匹配度等。下方列举古今中外成功案例，如“科隆大教堂”“中国高铁”等，还设有“关键问题”“核心心法”“有话可说”板块，总结路径创造的要点。](https://feishu.cn/file/Xp0LbIKMnoKMGPxy6IzcOtthn6b)