...
> **它们的存在本身就是一份因果履历**（[[2026-09-20-exploration-and-generation]]）。

## 关键要点

1. **提出**：2023 年 *Nature*（Sharma, Czégel, Lachmann, Kempes, Walker & Cronin, *Nature* 622: 321–328）——
   讲稿署的是**格拉斯哥大学的化学家 Leroy Cronin** 与**亚利桑那州立大学的物理学家 Sara Walker**。**署名与机构核查通过。**
...
4. **「组装指数 × 拷贝数」**：一个结构在宇宙中「**立住**」的程度。
5. **用法**：给「地球四十亿年出现了什么」画一条线 —— 自催化循环、细胞、多细胞、神经系统、语言、文字、科学、计算
...
**讲稿为什么需要它**：本讲要论证「**宇宙自己在生发，而且干得越来越起劲**」。
组装理论给了这个论证一把**尺子**：地球四十亿年间，可被度量的「最深结构」是**单调上升**的（那条斜线）——
...
- 与 [[increasing-functional-information]] 是**讲稿并列的两把尺子**（：「一个量组装的深度，一个量功能的信息」）——
...
- [[2026-09-20-exploration-and-generation]]（`raw/2026-09-20-exploration-and-generation.md`，组装理论、组装指数、斜线、两把尺子、争议、注 [4]）
