...
页面总数 **74** ｜ 项目 **3**（进行中 3） ｜ 素材 **15** 份 ｜ 最后更新 2026-09-18

## 项目 (3)

> 入口层。**收录素材前先读这里** —— 判断这份素材服务于哪个项目、填哪个缺口。

- [[emotion-awareness|情绪觉知（个人实践）]] `筹划` — 把「情绪觉知」从零散笔记变成一套自己在真实情境中能调用的流程 —— 建成覆盖「认知 → 方法 → 本人实践记录」的知识库，并在至少 3 次真实情绪事件中完整走完「觉察命名 → 生理冲浪 → 认知重评 → 最小行动」四步，留下记录
